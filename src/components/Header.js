  ...
  <header className="columns is-vcentered">
    <div className="column has-text-centered">
      <a href="/" title="AJ Cainglet Insurance Agency">
        <img
          src="https://www.dankitajimainsuranceagency.com/wp-content/themes/revitalize/images/logo@2x.png"
    ...
    <div className="column has-text-centered">
      <a href="tel:+310-830-7136">
        <p className="is-size-4 has-text-weight-semibold">
          <svg width="24px" height="24px" fill="#004990" viewBox="0 0 200 200">
